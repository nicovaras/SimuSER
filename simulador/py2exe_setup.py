...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "simulador.py"
 
        #Name of program
        self.project_name = "simulador"
        ...
        #Description
        self.project_description = "simulador"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['config.txt','background','img','tests']
...
# data_files = [
# 				  ('background',glob.glob(r'background\*.*')),
# 				  ('img',glob.glob(r'img\*.*')),
# 				  ('tests',glob.glob(r'tests\*.*')),
# 				  ('',glob.glob(r'config.txt'))
# 				  ]

# # for console program use 'console = [{"script" : "scriptname.py"}]

# setup(windows=[{"script":"simulador.py"}],options=opts,data_files=data_files)